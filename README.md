...
Explore the wonders of our solar system through a clean, interactive web experience built entirely with **HTML** and CSS. Navigate between planets, read bite-sized facts, and learn about their iconic moons in a single-page interface.
...
- 🎛 Smooth, tab-like switching using only CSS and radio inputs — no JavaScript required.
- 📖 Compact, readable fact cards for every planet with short descriptions and key details.
- 💻 Runs in any modern browser, just open the HTML file and you are ready to go.
...
No frameworks, no libraries, just classic front-end.
...
```text
solar-explorer/
├── index.html    # Main UI and content for planets and moons
├── style.css     # Styling, layout, and interactive states
...
Add subtle transitions and animations when switching planets.

Improve responsiveness on mobile devices with refined layouts.
